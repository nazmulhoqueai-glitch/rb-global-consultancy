...
const TopNav = () => {
  return (
    <div className="w-full bg-gray-900 text-gray-300 py-2 hidden sm:block">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
          <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs sm:text-sm">Ali plaza-2 (1st floor) Lalchand Road 4320 Chittagong, Bangladesh</span>
            </div>
          </div>
          
          <div className="flex items-center space-x-4">
            <Link href="https://www.facebook.com/rbglobal11" className="hover:text-white transition-colors">
